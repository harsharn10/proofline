# Census: the 13 round-22 candidates (superseded, close this issue)
...
The replacement is the Grok Heavy assignment
`research/inbox/assignments/WORK-20260902-grok-heavy-seed-batch-1.md`, which already exists: one seed
packet per name for these 13 plus the 14 net-new names from the 2026-09-01 inventory, filed under
`research/inbox/packets/<slug>/<work-id>.md` and compiled by the compiler. Track that assignment.
Close this issue.

Rules that carry over to the assignment, so they are not lost:
