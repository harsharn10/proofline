...
export const SEED = {
  pons: { symbol: null, dependencies: ["uniswap", "usdg", "stock-tokens"],
    ...
    deployments: [ { label: "V2 curve / factory", chain: "robinhood-chain", address: "not-verified", role: "factory" } ],
  ...
  mancer: { symbol: "MANCER", dependencies: ["uniswap"],
    ...
    deployments: [ { label: "Aggregator router", chain: "robinhood-chain", address: "not-verified", role: "router" }, { label: "$MANCER token", chain: "robinhood-chain", address: "not-verified", role: "token" } ],
  ...
  "artificial-inu": { symbol: "AI", dependencies: ["stock-tokens", "uniswap"],
    ...
    deployments: [ { label: "$AI token", chain: "robinhood-chain", address: "0x2E8c31162b855A2ffa90F6F8634643Ad6F111e18", role: "token" } ],
  ...
  longshot: { symbol: null, dependencies: ["hyperliquid"],
    ...
    deployments: [ { label: "RH Chain token", chain: "robinhood-chain", address: "0x8701E2C87ade58325601f4F9bf37ADF46Cb75745", role: "token" } ],
  ...
  long: { symbol: null, dependencies: ["stock-tokens"],
    ...
    deployments: [ { label: "Factory (PRD lists 0x9c88…0845, truncated)", chain: "robinhood-chain", address: "not-verified", role: "factory" }, { label: "Factory (PRD lists 0x22e9…eeED, truncated)", chain: "robinhood-chain", address: "not-verified", role: "factory" } ],
  ...
  stonkbroker: { symbol: null, dependencies: ["stock-tokens"],
    ...
    deployments: [ { label: "NFT collection", chain: "robinhood-chain", address: "not-verified", role: "token" } ],
  ...
  index: { symbol: null, dependencies: ["stock-tokens"],
    ...
    deployments: [ { label: "Token", chain: "robinhood-chain", address: "not-verified", role: "token" } ],
  ...
  arrow: { symbol: null, dependencies: [],
    ...
    deployments: [ { label: "Launchpad", chain: "robinhood-chain", address: "not-verified", role: "factory" }, { label: "CDP core", chain: "robinhood-chain", address: "not-verified", role: "vault" } ],
  ...
  "statics-protocol": { symbol: "STATICS", dependencies: [],
    ...
    deployments: [ { label: "Genesis system", chain: "robinhood-chain", address: "not-verified", role: "other" } ],
  ...
  safehood: { symbol: null, dependencies: ["uniswap"],
    ...
    deployments: [ { label: "Launchpad", chain: "robinhood-chain", address: "not-verified", role: "factory" } ],
  ...
  "robinhood-index-vaults": { symbol: "rIDX", dependencies: ["stock-tokens"],
    ...
    deployments: [ { label: "Vault (testnet)", chain: "robinhood-chain", address: "not-verified", role: "vault" } ],
  ...
  vimen: { symbol: null, dependencies: ["stock-tokens"],
    ...
    deployments: [ { label: "Basket custody", chain: "robinhood-chain", address: "not-verified", role: "vault" } ],
