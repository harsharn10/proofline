...
//
//   node scripts/intake/2026-08-31/import-chain-file.mjs
//
...
await writeFile(`${OUT}/stock-tokens-deployments.yaml`, `# Generated by scripts/intake/2026-08-31/import-chain-file.mjs — sheet 01 Stock/ETF rows + Chain File app addresses.\n# S1 = workbook (${GH}/${GROK}/build_rh_tokens.py), S2 = app dossiers (${GH}/${GROK}/chain-file.json).\n` +
...
await writeFile(`${OUT}/workbook-sheet02.yaml`, `# Generated by scripts/intake/2026-08-31/import-chain-file.mjs — sheet 02 rows parsed from build_rh_tokens.py. Everything is a claim of the workbook.\n` + stringify(sheet02, { lineWidth: 0 }));
...
await writeFile(`${OUT}/census-draft.yaml`, `# DRAFT — generated by scripts/intake/2026-08-31/import-chain-file.mjs from the desk map + dossiers + workbook. Keys starting with _ are notes for the editor and are not schema fields.\n` + stringify(censusDraft, { lineWidth: 0 }));
await writeFile(`${OUT}/seed-draft.mjs`, `// DRAFT SEED entries — generated by scripts/intake/2026-08-31/import-chain-file.mjs. Hand-edit into scripts/seed-data.mjs.\nexport const SEED_DRAFT = ${JSON.stringify(seedDraft, null, 2)};\n`);
await writeFile(`${OUT}/unmapped.yaml`, `# Dossiers that are not census subjects, with the rule applied. Generated by scripts/intake/2026-08-31/import-chain-file.mjs.\n` + stringify(unmapped, { lineWidth: 0 }));
