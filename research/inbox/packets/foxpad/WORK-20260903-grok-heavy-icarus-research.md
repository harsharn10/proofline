...
gaps:
  ...
  - { priority: P1, question: "Are factory/vault/router source-verifiable, and do they match the IFoxPadFactory ABI in the JS?", checked: "is_verified false on all pad contracts this pass", next: "upload or find the Solidity compiler settings; eth_call allTokensLength once selector is known" }
