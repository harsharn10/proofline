...
receipts:
  ...
  - { id: R-19, publisher: discovery-inventory, title: "likes-fun candidate", url: "https://x.com/likesdotfun", published_at: 2026-09-02T23:35:00Z, accessed_at: 2026-09-03T05:06:00Z, kind: other, authority: independent, authenticity: unconfirmed, supports: [CLM-27], excerpt: "Discovery inventory CLM-20: likes-fun | likes.fun | @likesdotfun | none. CLM-70 leaf markets/prediction. R-27 excerpt: bio rip packs with @fomo and @pumpfun traders, win on their profits. Fantasy league for Pump + FOMO users." }
